...
/usr/local/bin/mysqldump --xml -c -u $usu --password=$cla $bd > /var/www/resbase/$bd-$dm.xml
/usr/local/bin/mysqldump --compatible=postgresql -c -u $usu --password=$cla $bd > /var/www/resbase/$bd-$dm.sql
